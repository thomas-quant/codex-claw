# Codex Claw Channel System：完整开发指南

> **影响范围**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/codex-claw/internal/gateway/`
...
4. **Pico Protocol**：`pkg/channels/pico/` 实现了一个自定义的 Codex Claw 原生协议 channel，通过 WebSocket webhook (`/pico/ws`) 接收消息。
