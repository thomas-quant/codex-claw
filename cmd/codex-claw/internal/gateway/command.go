...
import (
	...
	"github.com/thomas-quant/codex-claw/pkg/gateway"
...
func NewGatewayCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:     "gateway",
		Aliases: []string{"g"},
		Short:   "Start codex-claw gateway",
		Args:    cobra.NoArgs,
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			return gateway.Run(debug, internal.GetCodexClawHome(), internal.GetConfigPath(), allowEmpty)
		},
	}
