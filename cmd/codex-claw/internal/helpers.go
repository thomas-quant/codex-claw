...
// GetCodexClawHome returns the codex-claw home directory.
// Priority: $CODEX_CLAW_HOME > ~/.codex-claw
func GetCodexClawHome() string {
...
func GetConfigPath() string {
	...
	return filepath.Join(GetCodexClawHome(), "config.json")
}
