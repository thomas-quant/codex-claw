...
CONFIG_PKG=github.com/thomas-quant/codex-claw/pkg/config
...
uninstall-all:
	...
	@rm -rf $(CODEX_CLAW_HOME)
	@echo "Removed workspace: $(CODEX_CLAW_HOME)"
...
help:
	...
	@echo "  WORKSPACE_DIR           # Workspace directory (default: ~/.codex-claw/workspace)"
